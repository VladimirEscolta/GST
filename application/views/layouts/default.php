...
<header id="headerHome" class="w-full">
    ...
    <div class="data text-base font-medium mx-auto my-4 items-center justify-between flex w-10/12">
...
<footer id="footerHome" class="w-full">
    <div class="level_1 bg-white">
        <div class="block_map w-10/12 mx-auto py-24">
    ...
    <div class="level_2">
        <div class="block_info text-white mx-auto w-10/12">
