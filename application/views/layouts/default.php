...
<footer id="footerHome" class="w-full">
    <div class="block_map bg-white my-24 mx-auto w-11/12">
        ...
        <div class="flex mt-20">
            <div class="flex flex-col w-[400px]">
                ...
                <div class="mt-6">
                    ...
                    <p class="text-base mt-3"><a href="tel:+78005502533"><nobr>8 800 550-25-33</nobr></a></p>
                </div>
                <div class="mt-6">
            ...
            <div class="flex map">
                <iframe class="rounded-2xl" src="https://yandex.ru/map-widget/v1/?z=12&ol=biz&oid=150708584688" width="100%" height="500"
