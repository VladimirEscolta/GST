      ...
      <div className="w-11/12 sm:w-10/12 mx-auto py-16 sm:py-24">
        ...
        <div className="flex flex-col lg:flex-row mt-8 lg:mt-20">
          <div className="flex flex-col w-full lg:w-[400px]">
            <div className="">
              <EnvelopeIcon/>
              <p className="font-bold mt-4">Электронная почта</p>
              <p className="text-base mt-4">Связаться по E-mail</p>
              <p className="text-base mt-4"><a href="hello@hello.ru">hello@hello.ru</a></p>
            </div>
            <div className="mt-8">
              <PhoneIcon/>
              <p className="font-bold mt-4">Телефон</p>
              <p className="text-base mt-4">Позвоните нам</p>
            ...
            <div className="mt-8">
              <GpsIcon/>
              <p className="font-bold mt-4">Офис</p>
              <p className="text-base mt-4">190000 Санкт-Петербург ул Примерная д 17</p>
            </div>
          </div>
          <div className="mt-8 lg:mt-0 flex w-full lg:w-[calc(100%-400px)] h-[335px] lg:h-[500px]">
